...
INSERT INTO EQUIPEMENTS (
    ...
    10,
    ' '
    (SELECT IDCLASSE FROM CLASSES WHERE NOMCLASSE = ' '),
);
...
INSERT INTO EQUIPEMENTS (
    ...
    10,
    ' '
    (SELECT IDCLASSE FROM CLASSES WHERE NOMCLASSE = ' ' AND SPECIALISATION IN ( SELECT SPECIALISATION FROM CLASSES WHERE NOMCLASSE = ' ' GROUP BY SPECIALISATION HAVING COUNT(NOMEQUIPEMENT) = 1 ) ),
);